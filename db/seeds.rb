...
Item.create!(name: 'Caneca HP2', description: 'Caneca do harry potter 2', weight: 300, width: 10, height: 20, depth: 16, category_id: Category.first.id)
Item.create!(name: 'Caneca HP3', description: 'Caneca do harry potter 3', weight: 300, width: 10, height: 20, depth: 16, category_id: Category.first.id)
Item.create!(name: 'Caneca HP4', description: 'Caneca do harry potter 4', weight: 300, width: 10, height: 20, depth: 16, category_id: Category.first.id)
