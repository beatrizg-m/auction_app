...
describe 'user click in batches' do
  it 'and view future and ongoing batches' do
    ...
    Batch.create!(code: '125bsd456', start_date: Date.new(2023, 5, 25), final_date: 1.day.from_now, minimum_value: 200, minimum_difference: 50, items: [Item.find(2)], approved: true)
    Batch.create!(code: '005psd456', start_date: Date.new(2023, 5, 25), final_date: Date.today, minimum_value: 200, minimum_difference: 50, items: [Item.find(2)], approved: false)
